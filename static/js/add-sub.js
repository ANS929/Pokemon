...
function checkAnswer1(event) {
  ...
  if (parseInt(damageOutput) === correctAnswer) {
    feedback.textContent =
      "Correct! Special Horn does 80 base damage plus 140 additional damage. 80 + 140 = 220. Well done!";
...
function checkAnswer2(event) {
  ...
  if (parseInt(remainingHP) === correctAnswer) {
    feedback2.textContent =
      "Correct! Cetitan begins with 180 HP but loses 90 health. 180 - 90 = 90. Well done!";
    inputField.disabled = true; // disable input field
    submitButton.disabled = true; // disable submit button
